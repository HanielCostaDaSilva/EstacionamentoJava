...
public class JanelaPrincipal {
	...
	private void initialize() {
		...
		//operacoesBasicasPanel.setBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(0, 0, 0)));
		...
		registrarSaidaBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				new TelaRemoverPlaca(estacionamento);
			}
		});
		...
		registrarEntradaBtm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				new TelaCadastrarPlaca(estacionamento);
			}
		});
		...
		btnRegistrarTransferncia.setForeground(Color.DARK_GRAY);
			...
			gl_operacoesBasicasPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_operacoesBasicasPanel.createSequentialGroup()
					...
					.addGroup(gl_operacoesBasicasPanel.createParallelGroup(Alignment.LEADING)
						.addComponent(btnRegistrarTransferncia, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
						.addComponent(registrarSaidaBtn, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)
						.addComponent(registrarEntradaBtm, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE))
					.addContainerGap())
		);
		gl_operacoesBasicasPanel.setVerticalGroup(
			gl_operacoesBasicasPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_operacoesBasicasPanel.createSequentialGroup()
					.addGap(5)
					.addComponent(registrarEntradaBtm, GroupLayout.PREFERRED_SIZE, 64, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(registrarSaidaBtn, GroupLayout.PREFERRED_SIZE, 62, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(btnRegistrarTransferncia, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)
